	...
	return array(
		...
		'ansclothes_footer'            => array(
			...
			'fields' => array(
				...
				'footer_credit_label'  => array( 'label' => __( 'Developer credit label', 'ansclothes' ), 'type' => 'text' ),
				'footer_credit_name'   => array( 'label' => __( 'Developer name', 'ansclothes' ), 'type' => 'text', 'description' => __( 'Leave empty to hide the developer credit.', 'ansclothes' ) ),
				'footer_credit_url'    => array( 'label' => __( 'Developer website URL', 'ansclothes' ), 'type' => 'url', 'description' => __( 'Include the full URL, for example https://example.com/.', 'ansclothes' ) ),
